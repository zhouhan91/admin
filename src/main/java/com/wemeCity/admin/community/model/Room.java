...
public class Room implements Serializable {
	...
	private LocalDate dateAllowedStart;

	/** (date_allowed_end,DATETIME, null)可租租期-结束 */
	@JsonFormat(pattern = "yyyy-MM-dd")
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	private LocalDate dateAllowedEnd;
	...
	public LocalDate getDateAllowedStart() {
		return dateAllowedStart;
	}

	public void setDateAllowedStart(LocalDate dateAllowedStart) {
		this.dateAllowedStart = dateAllowedStart;
	}

	public LocalDate getDateAllowedEnd() {
		return dateAllowedEnd;
	}

	public void setDateAllowedEnd(LocalDate dateAllowedEnd) {
