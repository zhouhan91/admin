...
import com.wemeCity.admin.community.mapper.CommunityImgMapper;
...
public class CommunityImgServiceImpl implements CommunityImgService{
	...
	@Override
	public List<CommunityImg> queryCommunityImgList(String busiCode, long busiId) throws CommunityImgException {
