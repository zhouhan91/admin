...
@ContextHierarchy({ @ContextConfiguration(name = "root", locations = "classpath:spring/root-context.xml"), @ContextConfiguration(name = "mvc", locations = "classpath:spring/servlet-context.xml") })
